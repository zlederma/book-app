...
const cleanData = (data) => {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        let author = (data[i].volumeInfo.authors[0] !== undefined) ? data[i].volumeInfo.authors[0] : "";
        //insert a default src
        let image = (data[i].volumeInfo.imageLinks.thumbnail !== undefined) ? data[i].volumeInfo.imageLinks.thumbnail : "";
