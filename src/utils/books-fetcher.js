import defaltSrc from '../assets/default-src.png'
...
const cleanData = (data) => {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        let image = (data[i].volumeInfo.imageLinks.thumbnail !== undefined) ? data[i].volumeInfo.imageLinks.thumbnail : defaltSrc;
